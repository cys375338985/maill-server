...
public class CartProductVo {
    ...
    private  String productSudtitle;
    ...
    public String getProductSudtitle() {
        return productSudtitle;
    }

    public void setProductSudtitle(String productSudtitle) {
        this.productSudtitle = productSudtitle;
    }
